...
public class LotteryDaoTest extends BaseTest {
	...
	public void test() {
		...
		date4 = LocalDate.parse("2014-08-10");//將時間自串轉成 LocalDate
		...
		System.out.println(dao.findComplex(null, null, null, null).size());
		System.out.println(dao.findComplex(1L, null, null, null).size());
		System.out.println(dao.findComplex(null, date4, null, null).size());
		System.out.println(dao.findComplex(null, null, date5, 0L).size());
		System.out.println(dao.findComplex(null, date5, date6, 300L).size());
		System.out.println(dao.findComplex(2L, date4, null, null).size());
	}
